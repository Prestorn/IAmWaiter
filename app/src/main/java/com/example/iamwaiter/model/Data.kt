...
class Data {
    companion object{
        ...
        val dishesInOrder = listOf<DishInOrder>(
            DishInOrder(0, 1, 1, 0),
            DishInOrder(0, 31, 1, 2),
            DishInOrder(0, 9, 2, 3),
            DishInOrder(0, 13, 2, 3),
            DishInOrder(0, 11, 3, 4),
            DishInOrder(0, 15, 3, 4),
            DishInOrder(0, 44, 3, 4)
        )
        ...
        val dishes = listOf<Dish>(
            ...
            Dish(36, "Датте", "Идеальное сочетание молока, классического эспрессо и молочной пены. Молочная пена, вспененное молоко, эспрессо", 270, 300),
            ...
            Dish(49, "Вода Минерале газированая", "Газированая вода", 170, 500),
            Dish(50, "Вода Минерале негазированая", "Негазированая вода", 170, 500)
            )
